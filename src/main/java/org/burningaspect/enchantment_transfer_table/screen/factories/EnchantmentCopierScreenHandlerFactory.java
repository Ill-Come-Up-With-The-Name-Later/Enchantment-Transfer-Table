...
public class EnchantmentCopierScreenHandlerFactory implements ExtendedScreenHandlerFactory<BlockPosPayload>,
        ImplementedInventory {

    private final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(3, ItemStack.EMPTY);
    public final Text TITLE = Text.literal("Enchantment Cloning");
    ...
    public @Nullable ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new EnchantmentCopierScreenHandler(syncId, playerInventory,
