...
public class EnchantmentCopierScreen extends HandledScreen<EnchantmentCopierScreenHandler> {

    private static final Identifier TEXTURE = EnchantmentTransferTable.id(
            "textures/gui/container/enchantment_copying.png");

    public EnchantmentCopierScreen(EnchantmentCopierScreenHandler handler,
